...
public class User {
    ...
    public User(){}
    public User(com.ftn.bsep.model.User dboUser) {
        this.address = dboUser.getAddress();
        this.email = dboUser.getEmail();
        this.id = dboUser.getId();
        this.enabled = dboUser.isEnabled();
        if (!dboUser.getRoles().isEmpty()) {
            this.role = dboUser.getRoles().get(0).getName();
        }
        this.password = dboUser.getPassword();
        this.name = dboUser.getName();
        this.surname = dboUser.getLastName();
        this.username = dboUser.getUsername();
    }
