...
public class TRoom {
    ...
    public TRoom(TRoom room){
        this.accommodationName = room.getAccommodationName();
        this.roomNumber = room.getRoomNumber();
        this.floor = room.getFloor();
        this.capacity = room.getCapacity();
    }

    public TRoom(CreateAndUpdateRoomDTO roomDTO){
        this.capacity = roomDTO.getCapacity();
        this.floor = roomDTO.getFloor();
        this.roomNumber = roomDTO.getRoomNumber();
        this.accommodationName = roomDTO.getAccommodationName();
