...
public class HttpsAuthentication {
    ...
    private static final String SERVICE_URI= "https://localhost:8080/api/certificate/httpsAuth";
   ...
   @RequestMapping("getData")
    public String demo() throws Exception {
      //  return "RADI";
        ...
        return resp.getStatusCode().toString()+ "poruka sa glavnog backenda je" + resp.getBody().trim();
    }

    @SuppressWarnings("deprecation")
    public RestTemplate getRestTemplate() throws  Exception{
        RestTemplate restTemplate= new RestTemplate();
        Path path = FileSystems.getDefault().getPath("agent.jks");
    ...
    public String agent(){
       return "two ways ssl communication";
    }
